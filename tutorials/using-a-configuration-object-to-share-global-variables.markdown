...
![Add global config](/xl-release/images/settings-new-global-config.png)

![Global settings](/xl-release/images/settings-globals1.png)
...
![New custom task](/xl-release/images/new-custom-task.png)

## Running the custom task

Executing the custom task as part of a release gives the expected result:

![Task output](/xl-release/images/log-output.png)
...
![JIRA task with global variables](/xl-release/images/jira-task-with-global-vars.png)
