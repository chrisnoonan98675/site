...
![Roles on the Admin screen](/xl-deploy/images/admin-screen-roles.png)
...
3. Click **Save** to save the permissions.
    ...
    ![Global Permissions on the Admin screen](/xl-deploy/images/admin-screen-global-permissions.png)
...
![image](/xl-deploy/images/security-setup-overview.png)
...
![image](/xl-deploy/images/security-setup-roles.png)
...
![image](/xl-deploy/images/security-setup-directories.png)

### Assign roles for applications

To assign roles, right-click a directory and select **Permissions**.

![image](/xl-deploy/images/security-setup-click-permissions.png)

Assign roles to the **Orders** directory:

![image](/xl-deploy/images/security-setup-permissions-app.png)
...
![image](/xl-deploy/images/security-setup-permissions-test.png)

For production, only deployers should have access. Only the lead deployer may alter the environment from XL Deploy.

![image](/xl-deploy/images/security-setup-permissions-prod.png)
...
![image](/xl-deploy/images/security-setup-environment-refined.png)

The permissions for **Environment** > **Orders** > **Production** look like:

![image](/xl-deploy/images/security-setup-permissions-prod-orders.png)

And the permissions for **Environments** > **Orders** look like:

![image](/xl-deploy/images/security-setup-read-permissions-in-parent.png)
