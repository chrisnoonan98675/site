...
4. Start the XL Release server. You will see that the following new [task types](/xl-release/concept/types-of-tasks-in-xl-release.html) are available:
    ...
    ![Dynatrace tasks in XL Release](/xl-release/images/dynatrace-xl-release/dynatrace-tasks.png)
...
![Run tests and retrieve results](/xl-release/images/dynatrace-xl-release/step-1-run-tests-and-retrieve-results.png)
...
![Start and stop recording](/xl-release/images/dynatrace-xl-release/step-2-start-and-stop-recording.png)
...
![Register deployment and review](/xl-release/images/dynatrace-xl-release/step-3-register-deployment-and-review.png)
...
![Register deployment and review](/xl-release/images/dynatrace-xl-release/metrics-driven-pipeline-with-dynatrace.png)
