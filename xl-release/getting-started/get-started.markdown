...
![Welcome release](/xl-release/images/xl-release-welcome-get-started.png)
...
![Create a template](/xl-release/images/create-new-template.png)
...
![Add a Manual task](/xl-release/images/add-task.png)
...
![Table view](/xl-release/images/release-table-view.png)
...
![Planner view](/xl-release/images/planner-default-sequence.png)
