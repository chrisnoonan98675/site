...
In XL Release 4.7.0 and earlier, the time zone of the XL Release server is used for all cron jobs.

In XL Release 4.7.0 and later, the default time zone for cron jobs is Coordinated Universal Time (UTC). To set a different time zone:
