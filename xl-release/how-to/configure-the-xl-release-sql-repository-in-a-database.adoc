= Configure the XL Release SQL repository in a database (XL Release 7.5.x and later)
:sectnums:
:toc: right
:toclevels: 2
:page-liquid:
...
If you are using DB2 version 9.7.2 or later, you must enable support for pagination queries using the `DB2_COMPATIBILITY_VECTOR` registry variable:
