...
_This document describes how to do a backup for XL Release 7.2 and previous versions, that use JCR as storage technology. For XL Release 7.5 and higher, please refer to [Back up XL Release (XL Release 7.5 and later)](/xl-release/how-to/back-up-xl-release.html)_
