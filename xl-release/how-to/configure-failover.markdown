...
**Important:** For the preferred clustering configuration in XL Release 6.0.0 and later, refer to [Configure active failover cluster](/xl-release/how-to/configure-active-hot-standby.html).
