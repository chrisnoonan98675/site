...
==== Configuration
In the following 2 guides, the configuration options are described that need to be set in order to configure the use of an external database and to configure the clustering of XL Release. Please follow these configuration guides:
