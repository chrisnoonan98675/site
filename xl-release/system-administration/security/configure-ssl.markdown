---
title: Configure SSL options for HttpRequest
...
!["Sandbox" release template](/xl-release/images/test-script-task.png)
...
![SSL handshake error](/xl-release/images/ssl-handshake-error.png)
...
![Hostname mismatch](/xl-release/images/handshake-error.png)
...
![Successful server call](/xl-release/images/https-call-200.png)
