...
## Configure a jumpstation

In XL Release 5.0.0 and later, you can configure a jumpstation or HTTP proxy. When XL Release cannot reach a remote host directly, but that host can be reached via one or more SSH tunnels or HTTP proxies, you can configure these as follows:
