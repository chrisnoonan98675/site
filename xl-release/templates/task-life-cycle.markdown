...
![Task life cycle](/xl-release/images/task-lifecycle.png)
...
**Note:** For information about the task life cycle prior to XL Release 4.8.0, refer to [The task life cycle in XL Release 4.7.x and earlier](task-life-cycle-4.7.html).
