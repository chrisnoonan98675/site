...
Refer to [Create a custom report in XL TestView](/xl-testview/how-to/create-a-custom-report-in-xl-test.html) for more information about creating and troubleshooting custom reports.
