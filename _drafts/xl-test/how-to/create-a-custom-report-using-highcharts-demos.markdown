...
Refer to [Create a custom report in XL Test](/xl-test/how-to/create-a-custom-report-in-xl-test.html) for more information about creating and troubleshooting custom reports.
