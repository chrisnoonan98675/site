---
title: XL Deploy 7.0.x documentation
...
* [Command plugin](commandPluginManual.html)
* [Database plugin](databasePluginManual.html)
* [File plugin](filePluginManual.html)
* [Generic Model plugin](genericPluginManual.html)
* [JEE plugin](jeePluginManual.html)
* [PowerShell plugin](powershellPluginManual.html)
* [Python plugin](pythonPluginManual.html)
* [Remoting plugin](remotingPluginManual.html)
* [Webserver plugin](webserverPluginManual.html)
* [Trigger plugin](triggerPluginManual.html)

### Java middleware plugins

* [JBoss Application Server 5 and 6 plugin](/xl-deploy-jbossas-plugin/7.0.x/jbossPluginManual.html)
* [JBoss Application Server 7 and up plugin](/xl-deploy-jbossdm-plugin/7.0.x/jbossDomainPluginManual.html)
...
* [Tomcat plugin](/xl-deploy-tomcat-plugin/7.0.x/tomcatPluginManual.html)
* [GlassFish plugin](/xl-deploy-glassfish-plugin/7.0.x/glassfishPluginManual.html)

### .NET middleware plugins

* [BizTalk plugin](/xl-deploy-biztalk-plugin/7.0.x/biztalkPluginManual.html)
* [IIS plugin](/xl-deploy-iis-plugin/7.0.x/iisPluginManual.html)
* [Windows plugin](/xl-deploy-windows-plugin/7.0.x/windowsPluginManual.html)

### Other middleware plugins

* [F5 BIG-IP plugin](/xl-deploy-bigip-plugin/7.0.x/bigipPluginManual.html)
...
* [NetScaler plugin](/xl-deploy-netscaler-plugin/7.0.x/netscalerPluginManual.html)
* [DataPower plugin](/xl-deploy-xld-datapower-plugin/7.0.x/dataPowerPluginManual.html)
...
* [Chef plugin for XL Deploy](/xl-deploy-xld-chef-plugin/7.0.x/chefPluginManual.html)
...
* [XL Deploy EC2 plugin](/xl-deploy-xld-aws-ec2-plugin/7.0.x/ec2PluginManual.html)
* [XL Deploy Provision Puppet plugin](/xl-deploy-xld-provision-puppet-plugin/7.0.x/provisionPuppetPluginManual.html)
