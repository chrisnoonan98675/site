...
For information about the plugin requirements and the supported OpenShift version, refer to the [OpenShift Plugin Reference](/xl-deploy-xld-openshift-plugin/7.1.x/openshiftPluginManual.html).
