...
After you [install the XL Deploy command-line interface (CLI)](/xl-deploy/how-to/install-the-xl-deploy-cli.html), start it and connect to XL Deploy as follows:
