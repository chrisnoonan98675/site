...
![One deployable with different deployed types]({{ site.url }}/images/deployable-deployed-one-deployable-different-deployed-types.png)

**The same `jee.DataSourceSpec` can become a `jbossas.NonTransactionalDatasource` on JBoss and a `tomcat.DataSource` on Tomcat.**

![One deployable with many deployeds]({{ site.url }}/images/deployable-deployed-one-deployable-many-deployeds.png)
...
![Deployable and deployed properties]({{ site.url }}/images/deployable-deployed-props.png)
...
![Deployable vs. deployed property attributes]({{ site.url }}/images/deployable-deployed-property-attributes.png)
