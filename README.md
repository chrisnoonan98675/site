...
The [Development Dashboard](https://docs.xebialabs.com/development-dashboard/index.html) is generated by Jekyll. If you want to refresh the Dashboard so it shows the latest information from JIRA, log in to [Jenkins](https://xebialabs.atlassian.net/wiki/display/Labs/Jenkins) and execute the [Jekyll docs job](https://dexter.xebialabs.com/jenkinsng/job/Documentation/job/app1/job/Jekyll%20docs/).
